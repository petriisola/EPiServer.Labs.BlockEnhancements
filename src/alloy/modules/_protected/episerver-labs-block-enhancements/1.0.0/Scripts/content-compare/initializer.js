define([
    ...
    function patchCompareCommandProvider() {
        ...
        compareModeProvider.commands[0]._viewChanged = function (type, args, data) {
            if (type === "episerver-labs-block-enhancements/content-compare/content-compare-view-controller") {
    ...
    function initializeStore () {
        ...
        registry.add("episerver.labs.contentcompare",
            new Throttle(
                new JsonRest({
                    target: routes.getRestPath({ moduleArea: "episerver-labs-block-enhancements", storeName: "contentcomparestore" })
                })
            )
        );
    }
