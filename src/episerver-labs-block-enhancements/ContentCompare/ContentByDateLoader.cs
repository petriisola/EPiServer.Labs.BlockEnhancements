...
namespace EPiServer.Labs.BlockEnhancements.ContentCompare
{
    public class ContentByDateLoader : IContentAreaLoader
    {
        ...
        public IContent Get(ContentAreaItem contentAreaItem)
        {
            ...
            var contentVersions = contentVersionRepository.List(contentAreaItem.ContentLink.ToReferenceWithoutVersion(),
                languageResolver.GetPreferredCulture().Name).ToList(); //TODO: compare Language should be parameter
